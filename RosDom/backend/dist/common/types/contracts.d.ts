...
export type DeviceCategory = 'light' | 'switch' | 'camera' | 'sensor' | 'climate' | 'curtain' | 'plug' | 'lock' | 'humidifier' | 'media' | 'other';
...
export type CapabilityKey = 'power' | 'brightness' | 'colorTemperature' | 'rgb' | 'temperature' | 'humidity' | 'motion' | 'contact' | 'lock' | 'airQuality' | 'curtainPosition' | 'onlineState';
export type CapabilityType = 'boolean' | 'integer' | 'decimal' | 'enum' | 'color' | 'string';
export type CommandStatus = 'queued' | 'dispatched' | 'acknowledged' | 'rejected' | 'timed_out' | 'reconciled';
export type PairingStatus = 'created' | 'discovering' | 'candidate_selected' | 'completed' | 'cancelled' | 'expired';
export type ScenarioExecutionMode = 'manual' | 'scheduled' | 'sensor' | 'geofence';
export type EventSeverity = 'info' | 'warning' | 'critical';
export type NotificationType = 'security' | 'device' | 'automation' | 'system';
export type LayoutItemKind = 'furniture' | 'door' | 'window' | 'device' | 'task';
