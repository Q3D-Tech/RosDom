...
let AuthController = class AuthController {
    ...
    async register(dto) {
        return (0, api_response_1.ok)(await this.authService.register(dto));
    }
    async login(dto) {
        return (0, api_response_1.ok)(await this.authService.login(dto));
    }
    async refresh(dto) {
        return (0, api_response_1.ok)(await this.authService.refresh(dto));
    }
    async logout(user) {
        await this.authService.logout(user.sessionId);
        return (0, api_response_1.ok)({ success: true });
    }
    async me(user) {
        return (0, api_response_1.ok)(await this.authService.me(user.id));
    }
};
